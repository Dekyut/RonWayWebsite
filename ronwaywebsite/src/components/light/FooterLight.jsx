...
function FooterLight() {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'COMPANY',
      links: [
        { label: 'Our Story', to: '/light/about#our-story' },
        { label: 'Vision & Mission', to: '/light/about#mission' },
        { label: 'Our Team', to: '/light/about#team' },
        { label: 'Location', to: '/light/contact#location' },
      ],
    },
    {
      title: 'SERVICES',
      links: [
        { label: 'Our Services', to: '/light/services#services' },
        { label: 'What We Offer', to: '/light/services#what-we-offer' },
        { label: 'Fleet Gallery', to: '/light#gallery' },
      ],
    },
    {
      title: 'CONTACT',
      links: [
        { label: 'Contact Form', to: '/light/contact#contact-form' },
        { label: 'Our Location', to: '/light/contact#location' },
        { label: 'FAQ', to: '/light/contact#faq' },
      ],
      extra: [
  ...
  return (
    <footer className="relative z-20 w-full bg-gradient-to-b from-[#093389] to-[#0b0c0e] text-white">
      {/* Top border accent */}
      <div className="w-full h-1 bg-gradient-to-r from-[#2cbafc] via-blue-300 to-[#2cbafc]"></div>
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-10 pt-12 pb-8">
                ...
                <div className="mt-5 space-y-3">
                  {section.extra.map((item, idx) => (
                    <div key={idx} className="flex items-start gap-2">
                      {item.icon === 'email' && (
                        <svg className="w-4 h-4 mt-0.5 text-[#2cbafc] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-xs text-white/50">
            ...
            <Link to="/light/contact" className="hover:text-white transition-colors duration-200">
              Contact Us
            </Link>
          </div>
