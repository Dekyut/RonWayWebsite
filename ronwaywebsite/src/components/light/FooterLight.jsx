...
function FooterLight() {
  return (
    <footer className="relative z-20 w-full bg-gradient-to-b from-[#093389] to-[#0b0c0e] border-t-8 border-[#2cbafc] flex flex-col items-center text-white shadow-[0_-8px_25px_rgba(0,0,0,0.2)]">
